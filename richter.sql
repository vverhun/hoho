...
--
-- Host: localhost
-- Generation Time: May 20, 2011 at 10:48 AM
...
--
-- Table structure for table `richteraddress`
--

CREATE TABLE IF NOT EXISTS `richteraddress` (
  ...
  `country_id` varchar(255) collate utf8_bin NOT NULL default '0',
...
--
-- Dumping data for table `richteraddress`
--

INSERT INTO `richteraddress` (`address_id`, `customer_id`, `company`, `firstname`, `lastname`, `address_1`, `address_2`, `postcode`, `city`, `country_id`, `zone_id`) VALUES
(2, 2, '', 'sdfasdfasdf', 'sssss', 'rrr', '', 'fff', 'ddd', 'sss', 0);

-- --------------------------------------------------------

--
-- Table structure for table `richtercategory`
--

CREATE TABLE IF NOT EXISTS `richtercategory` (
...
--
-- Dumping data for table `richtercategory`
--

INSERT INTO `richtercategory` (`category_id`, `image`, `parent_id`, `sort_order`, `date_added`, `date_modified`, `status`) VALUES
(37, '', 0, 0, '2011-05-18 01:17:47', '2011-05-18 01:17:47', 1),
(38, '', 36, 0, '2011-05-18 01:18:11', '2011-05-18 01:18:11', 1),
(39, '', 36, 0, '2011-05-18 01:18:26', '2011-05-18 01:18:26', 1),
(40, '', 37, 0, '2011-05-18 01:18:39', '2011-05-18 01:18:39', 1),
(41, '', 37, 0, '2011-05-18 01:18:52', '2011-05-18 01:18:52', 1),
(42, '', 37, 0, '2011-05-18 01:19:22', '2011-05-18 01:19:22', 1),
(43, '', 37, 0, '2011-05-18 01:19:35', '2011-05-18 01:19:35', 1),
(36, '', 0, 0, '2011-05-18 01:17:39', '2011-05-18 01:17:39', 1),
(35, '', 36, 0, '2011-05-18 01:15:55', '2011-05-18 01:17:56', 1);

-- --------------------------------------------------------

--
-- Table structure for table `richtercategory_description`
--

CREATE TABLE IF NOT EXISTS `richtercategory_description` (
...
--
-- Dumping data for table `richtercategory_description`
--

INSERT INTO `richtercategory_description` (`category_id`, `language_id`, `name`, `meta_keywords`, `meta_description`, `description`) VALUES
(38, 2, 'Editionen', '', '', ''),
(39, 1, 'Atlas', '', '', ''),
(39, 2, 'Atlas', '', '', ''),
(40, 1, 'Übermalte Fotograen', '', '', ''),
(40, 2, 'Übermalte Fotograen', '', '', ''),
(41, 1, 'Aquarelle', '', '', ''),
(41, 2, 'Aquarelle', '', '', ''),
(42, 1, 'Zeichnungen', '', '', ''),
(42, 2, 'Zeichnungen', '', '', ''),
(43, 1, 'Öl auf Papier', '', '', ''),
(43, 2, 'Öl auf Papier', '', '', ''),
(35, 2, 'Bilder/Skulpturen', '', '', ''),
(35, 1, 'Bilder/Skulpturen', '', '', ''),
(36, 1, 'Suche1', '', '', ''),
(36, 2, 'Suche1', '', '', ''),
(37, 1, 'Suche2', '', '', ''),
(37, 2, 'Suche2', '', '', ''),
...
--
-- Table structure for table `richtercategory_to_store`
--

CREATE TABLE IF NOT EXISTS `richtercategory_to_store` (
  `category_id` int(11) NOT NULL,
...
--
-- Dumping data for table `richtercategory_to_store`
--

INSERT INTO `richtercategory_to_store` (`category_id`, `store_id`) VALUES
(35, 0),
(36, 0),
(37, 0),
(38, 0),
...
--
-- Table structure for table `richtercountry`
--

CREATE TABLE IF NOT EXISTS `richtercountry` (
...
--
-- Dumping data for table `richtercountry`
--

INSERT INTO `richtercountry` (`country_id`, `name`, `iso_code_2`, `iso_code_3`, `address_format`, `postcode_required`, `status`) VALUES
...
(189, 'Slovak Republic', 'SK', 'SVK', 0x7b66697273746e616d657d207b6c6173746e616d657d0d0a7b636f6d70616e797d0d0a7b616464726573735f317d0d0a7b616464726573735f327d0d0a7b636974797d207b706f7374636f64657d0d0a7b7a6f6e657d0d0a7b636f756e7472797d, 1, 1),
...
(223, 'United States', 'US', 'USA', 0x7b66697273746e616d657d207b6c6173746e616d657d0d0a7b636f6d70616e797d0d0a7b616464726573735f317d0d0a7b616464726573735f327d0d0a7b636974797d2c207b7a6f6e657d207b706f7374636f64657d0d0a7b636f756e7472797d, 1, 1),
...
--
-- Table structure for table `richtercoupon`
--

CREATE TABLE IF NOT EXISTS `richtercoupon` (
...
--
-- Dumping data for table `richtercoupon`
--

INSERT INTO `richtercoupon` (`coupon_id`, `code`, `type`, `discount`, `logged`, `shipping`, `total`, `date_start`, `date_end`, `uses_total`, `uses_customer`, `status`, `date_added`) VALUES
...
--
-- Table structure for table `richtercoupon_description`
--

CREATE TABLE IF NOT EXISTS `richtercoupon_description` (
...
--
-- Dumping data for table `richtercoupon_description`
--

INSERT INTO `richtercoupon_description` (`coupon_id`, `language_id`, `name`, `description`) VALUES
(4, 1, 'Coupon (-10%)', 0x31302520446973636f756e74),
(5, 1, 'Coupon (Free Shipping)', 0x46726565205368697070696e67),
(6, 1, 'Coupon (-10.00)', 0x466978656420416d6f756e7420446973636f756e74),
(4, 2, 'Coupon (-10%)', 0x31302520446973636f756e74),
(5, 2, 'Coupon (Free Shipping)', 0x46726565205368697070696e67),
(6, 2, 'Coupon (-10.00)', 0x466978656420416d6f756e7420446973636f756e74);

-- --------------------------------------------------------

--
-- Table structure for table `richtercoupon_product`
--

CREATE TABLE IF NOT EXISTS `richtercoupon_product` (
...
--
-- Dumping data for table `richtercoupon_product`
--

INSERT INTO `richtercoupon_product` (`coupon_product_id`, `coupon_id`, `product_id`) VALUES
(4, 7, 47),
(3, 7, 30),
(8, 6, 48);
...
--
-- Table structure for table `richtercurrency`
--

CREATE TABLE IF NOT EXISTS `richtercurrency` (
...
--
-- Dumping data for table `richtercurrency`
--

INSERT INTO `richtercurrency` (`currency_id`, `title`, `code`, `symbol_left`, `symbol_right`, `decimal_place`, `value`, `status`, `date_modified`) VALUES
(1, 'Pound Sterling', 'GBP', '£', '', '2', 1.00000000, 1, '2011-05-19 22:02:29'),
(2, 'US Dollar', 'USD', '$', '', '2', 1.62109995, 1, '2011-05-19 22:02:29'),
(3, 'Euro', 'EUR', '', '€', '2', 1.13310003, 1, '2011-05-19 22:02:29');

-- --------------------------------------------------------

--
-- Table structure for table `richtercustomer`
--

CREATE TABLE IF NOT EXISTS `richtercustomer` (
  ...
  `date_added` datetime NOT NULL default '0000-00-00 00:00:00',
  `ansprechpartner` varchar(255) collate utf8_bin NOT NULL,
  `position` varchar(255) collate utf8_bin NOT NULL,
  `taxid_number` varchar(255) collate utf8_bin NOT NULL,
  `firma` varchar(255) collate utf8_bin NOT NULL,
  `museum` varchar(255) collate utf8_bin NOT NULL,
  `privatperson` varchar(255) collate utf8_bin NOT NULL,
  `bill_address` varchar(255) collate utf8_bin NOT NULL,
...
--
-- Dumping data for table `richtercustomer`
--

INSERT INTO `richtercustomer` (`customer_id`, `store_id`, `firstname`, `lastname`, `email`, `telephone`, `fax`, `password`, `cart`, `newsletter`, `address_id`, `status`, `approved`, `customer_group_id`, `ip`, `date_added`, `ansprechpartner`, `position`, `taxid_number`, `firma`, `museum`, `privatperson`, `bill_address`, `mobile`, `username`) VALUES
(2, 0, 'Sdfasdfasdf', 'Sssss', 'vverhun@gmail.com', 'fff', 'fff', '9804f858419594400647c354a1d8d235', 0x613a303a7b7d, 0, 2, 1, 1, 8, '127.0.0.1', '2011-05-18 00:17:44', 'ddd', 'www', 'aaa', '', '', 'on', 'on', 'ggg', 'vova');

-- --------------------------------------------------------

--
-- Table structure for table `richtercustomer_group`
--

CREATE TABLE IF NOT EXISTS `richtercustomer_group` (
...
--
-- Dumping data for table `richtercustomer_group`
--

INSERT INTO `richtercustomer_group` (`customer_group_id`, `name`) VALUES
(8, 'Default'),
(6, 'Wholesale');
...
--
-- Table structure for table `richterdownload`
--

CREATE TABLE IF NOT EXISTS `richterdownload` (
...
--
-- Dumping data for table `richterdownload`
--
...
--
-- Table structure for table `richterdownload_description`
--

CREATE TABLE IF NOT EXISTS `richterdownload_description` (
...
--
-- Dumping data for table `richterdownload_description`
--
...
--
-- Table structure for table `richterextension`
--

CREATE TABLE IF NOT EXISTS `richterextension` (
...
--
-- Dumping data for table `richterextension`
--

INSERT INTO `richterextension` (`extension_id`, `type`, `key`) VALUES
(23, 'payment', 'cod'),
(57, 'total', 'sub_total'),
(58, 'total', 'tax'),
(59, 'total', 'total'),
(296, 'payment', 'free_checkout');

-- --------------------------------------------------------

--
-- Table structure for table `richtergeo_zone`
--

CREATE TABLE IF NOT EXISTS `richtergeo_zone` (
...
--
-- Dumping data for table `richtergeo_zone`
--

INSERT INTO `richtergeo_zone` (`geo_zone_id`, `name`, `description`, `date_modified`, `date_added`) VALUES
...
--
-- Table structure for table `richterinformation`
--

CREATE TABLE IF NOT EXISTS `richterinformation` (
...
--
-- Dumping data for table `richterinformation`
--

INSERT INTO `richterinformation` (`information_id`, `sort_order`, `status`) VALUES
(3, 2, 1),
(4, 1, 1),
(5, 3, 1);
...
--
-- Table structure for table `richterinformation_description`
--

CREATE TABLE IF NOT EXISTS `richterinformation_description` (
...
--
-- Dumping data for table `richterinformation_description`
--

INSERT INTO `richterinformation_description` (`information_id`, `language_id`, `title`, `description`) VALUES
...
--
-- Table structure for table `richterinformation_to_store`
--

CREATE TABLE IF NOT EXISTS `richterinformation_to_store` (
  `information_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
...
--
-- Dumping data for table `richterinformation_to_store`
--

INSERT INTO `richterinformation_to_store` (`information_id`, `store_id`) VALUES
(3, 0),
(4, 0),
(5, 0);
...
--
-- Table structure for table `richterlanguage`
--

CREATE TABLE IF NOT EXISTS `richterlanguage` (
...
--
-- Dumping data for table `richterlanguage`
--

INSERT INTO `richterlanguage` (`language_id`, `name`, `code`, `locale`, `image`, `directory`, `filename`, `sort_order`, `status`) VALUES
(1, 'English', 'en', 'en_US.UTF-8,en_US,en-gb,english', 'gb.png', 'english', 'english', 1, 1),
(2, 'Deutsch', 'de-DE', 'de', 'de.png', 'de_DE', 'de_DE', 2, 1);

-- --------------------------------------------------------

--
-- Table structure for table `richterlength_class`
--

CREATE TABLE IF NOT EXISTS `richterlength_class` (
...
--
-- Dumping data for table `richterlength_class`
--

INSERT INTO `richterlength_class` (`length_class_id`, `value`) VALUES
(1, 1.00000000),
(2, 10.00000000),
(3, 0.39370000);
...
--
-- Table structure for table `richterlength_class_description`
--

CREATE TABLE IF NOT EXISTS `richterlength_class_description` (
  `length_class_id` int(11) NOT NULL auto_increment,
  `language_id` int(11) NOT NULL,
...
--
-- Dumping data for table `richterlength_class_description`
--

INSERT INTO `richterlength_class_description` (`length_class_id`, `language_id`, `title`, `unit`) VALUES
(1, 1, 'Centimeter', 'cm'),
(2, 1, 'Millimeter', 'mm'),
(3, 1, 'Inch', 'in'),
(1, 2, 'Centimeter', 'cm'),
...
--
-- Table structure for table `richtermanufacturer`
--

CREATE TABLE IF NOT EXISTS `richtermanufacturer` (
...
--
-- Dumping data for table `richtermanufacturer`
--

INSERT INTO `richtermanufacturer` (`manufacturer_id`, `name`, `image`, `sort_order`) VALUES
...
--
-- Table structure for table `richtermanufacturer_to_store`
--

CREATE TABLE IF NOT EXISTS `richtermanufacturer_to_store` (
...
--
-- Dumping data for table `richtermanufacturer_to_store`
--

INSERT INTO `richtermanufacturer_to_store` (`manufacturer_id`, `store_id`) VALUES
(5, 0),
(6, 0),
(7, 0),
(8, 0),
...
--
-- Table structure for table `richterorder`
--

CREATE TABLE IF NOT EXISTS `richterorder` (
...
--
-- Dumping data for table `richterorder`
--

INSERT INTO `richterorder` (`order_id`, `invoice_id`, `invoice_prefix`, `store_id`, `store_name`, `store_url`, `customer_id`, `customer_group_id`, `firstname`, `lastname`, `telephone`, `fax`, `email`, `shipping_firstname`, `shipping_lastname`, `shipping_company`, `shipping_address_1`, `shipping_address_2`, `shipping_city`, `shipping_postcode`, `shipping_zone`, `shipping_zone_id`, `shipping_country`, `shipping_country_id`, `shipping_address_format`, `shipping_method`, `payment_firstname`, `payment_lastname`, `payment_company`, `payment_address_1`, `payment_address_2`, `payment_city`, `payment_postcode`, `payment_zone`, `payment_zone_id`, `payment_country`, `payment_country_id`, `payment_address_format`, `payment_method`, `comment`, `total`, `order_status_id`, `language_id`, `currency_id`, `currency`, `value`, `coupon_id`, `date_modified`, `date_added`, `ip`) VALUES
(4, 0, '', 0, 'Your Store', 'http://localhost:152/', 2, 8, 'sdfasdfasdf', 'sssss', 'fff', 'fff', 'vverhun@gmail.com', '', '', '', '', '', '', '', '', 0, '', 0, '', '', '', '', '', '', '', '', '', '', 0, '', 0, '', '', '', 0.0000, 0, 1, 1, 'GBP', 1.00000000, 0, '2011-05-19 18:26:34', '2011-05-19 18:26:34', '127.0.0.1'),
(3, 0, '', 0, 'Your Store', 'http://localhost:152/', 2, 8, 'sdfasdfasdf', 'sssss', 'fff', 'fff', 'vverhun@gmail.com', '', '', '', '', '', '', '', '', 0, '', 0, '', '', 'sdfasdfasdf', 'sssss', '', 'rrr', '', 'ddd', 'fff', '', 0, '', 0, '', 'Free Checkout', '', 0.0000, 7, 1, 1, 'GBP', 1.00000000, 0, '2011-05-19 01:21:39', '2011-05-19 01:21:39', '127.0.0.1'),
(5, 0, '', 0, 'Your Store', 'http://localhost:152/', 2, 8, 'sdfasdfasdf', 'sssss', 'fff', 'fff', 'vverhun@gmail.com', '', '', '', '', '', '', '', '', 0, '', 0, '', '', '', '', '', '', '', '', '', '', 0, '', 0, '', '', '', 0.0000, 0, 1, 1, 'GBP', 1.00000000, 0, '2011-05-19 18:34:25', '2011-05-19 18:34:25', '127.0.0.1'),
(6, 0, '', 0, 'Your Store', 'http://localhost:152/', 2, 8, 'sdfasdfasdf', 'sssss', 'fff', 'fff', 'vverhun@gmail.com', '', '', '', '', '', '', '', '', 0, '', 0, '', '', '', '', '', '', '', '', '', '', 0, '', 0, '', '', '', 0.0000, 0, 1, 1, 'GBP', 1.00000000, 0, '2011-05-19 18:38:58', '2011-05-19 18:38:58', '127.0.0.1'),
(7, 0, '', 0, 'Your Store', 'http://localhost:152/', 2, 8, 'sdfasdfasdf', 'sssss', 'fff', 'fff', 'vverhun@gmail.com', '', '', '', '', '', '', '', '', 0, '', 0, '', '', '', '', '', '', '', '', '', '', 0, '', 0, '', '', '', 0.0000, 0, 1, 1, 'GBP', 1.00000000, 0, '2011-05-19 20:45:18', '2011-05-19 20:45:18', '127.0.0.1'),
(8, 0, '', 0, 'Your Store', 'http://localhost:152/', 2, 8, 'sdfasdfasdf', 'sssss', 'fff', 'fff', 'vverhun@gmail.com', '', '', '', '', '', '', '', '', 0, '', 0, '', '', '', '', '', '', '', '', '', '', 0, '', 0, '', '', '', 0.0000, 0, 1, 1, 'GBP', 1.00000000, 0, '2011-05-19 20:48:44', '2011-05-19 20:48:44', '127.0.0.1'),
(9, 0, '', 0, 'Your Store', 'http://localhost:152/', 2, 8, 'sdfasdfasdf', 'sssss', 'fff', 'fff', 'vverhun@gmail.com', '', '', '', '', '', '', '', '', 0, '', 0, '', '', '', '', '', '', '', '', '', '', 0, '', 0, '', '', '', 0.0000, 0, 1, 1, 'GBP', 1.00000000, 0, '2011-05-19 20:50:49', '2011-05-19 20:50:49', '127.0.0.1'),
(10, 0, '', 0, 'Your Store', 'http://localhost:152/', 2, 8, 'sdfasdfasdf', 'sssss', 'fff', 'fff', 'vverhun@gmail.com', '', '', '', '', '', '', '', '', 0, '', 0, '', '', '', '', '', '', '', '', '', '', 0, '', 0, '', '', '', 0.0000, 0, 1, 1, 'GBP', 1.00000000, 0, '2011-05-19 20:57:36', '2011-05-19 20:57:36', '127.0.0.1'),
(11, 0, '', 0, 'Your Store', 'http://localhost:152/', 2, 8, 'sdfasdfasdf', 'sssss', 'fff', 'fff', 'vverhun@gmail.com', '', '', '', '', '', '', '', '', 0, '', 0, '', '', '', '', '', '', '', '', '', '', 0, '', 0, '', '', '', 0.0000, 0, 1, 1, 'GBP', 1.00000000, 0, '2011-05-19 20:59:09', '2011-05-19 20:59:09', '127.0.0.1'),
(12, 0, '', 0, 'Your Store', 'http://localhost:152/', 2, 8, 'sdfasdfasdf', 'sssss', 'fff', 'fff', 'vverhun@gmail.com', '', '', '', '', '', '', '', '', 0, '', 0, '', '', '', '', '', '', '', '', '', '', 0, '', 0, '', '', '', 0.0000, 0, 1, 1, 'GBP', 1.00000000, 0, '2011-05-19 21:01:36', '2011-05-19 21:01:36', '127.0.0.1'),
(13, 0, '', 0, 'Your Store', 'http://localhost:152/', 2, 8, 'sdfasdfasdf', 'sssss', 'fff', 'fff', 'vverhun@gmail.com', '', '', '', '', '', '', '', '', 0, '', 0, '', '', '', '', '', '', '', '', '', '', 0, '', 0, '', '', '', 0.0000, 0, 1, 1, 'GBP', 1.00000000, 0, '2011-05-19 21:03:07', '2011-05-19 21:03:07', '127.0.0.1'),
(14, 1, 'INV', 0, 'Your Store', 'http://localhost:152/', 2, 8, 'sdfasdfasdf', 'sssss', 'fff', 'fff', 'vverhun@gmail.com', '', '', '', '', '', '', '', '', 0, '', 0, '', '', '', '', '', '', '', '', '', '', 0, '', 0, '', '', '', 0.0000, 3, 1, 1, 'GBP', 1.00000000, 0, '2011-05-19 22:53:14', '2011-05-19 22:01:59', '127.0.0.1');

-- --------------------------------------------------------

--
-- Table structure for table `richterorder_download`
--

CREATE TABLE IF NOT EXISTS `richterorder_download` (
...
--
-- Dumping data for table `richterorder_download`
--
...
--
-- Table structure for table `richterorder_history`
--

CREATE TABLE IF NOT EXISTS `richterorder_history` (
...
--
-- Dumping data for table `richterorder_history`
--

INSERT INTO `richterorder_history` (`order_history_id`, `order_id`, `order_status_id`, `notify`, `comment`, `date_added`) VALUES
(1, 3, 7, 1, '', '2011-05-19 01:21:47'),
(2, 14, 1, 1, '', '2011-05-19 22:04:24'),
(3, 14, 3, 1, '', '2011-05-19 22:53:14');

-- --------------------------------------------------------

--
-- Table structure for table `richterorder_option`
--

CREATE TABLE IF NOT EXISTS `richterorder_option` (
...
--
-- Dumping data for table `richterorder_option`
--
...
--
-- Table structure for table `richterorder_product`
--

CREATE TABLE IF NOT EXISTS `richterorder_product` (
  ...
  `art` varchar(255) collate utf8_bin NOT NULL,
  `auflage` varchar(255) collate utf8_bin NOT NULL,
  `grosse` varchar(255) collate utf8_bin NOT NULL,
  `titelseite` varchar(255) collate utf8_bin NOT NULL,
  `innenseite` varchar(255) collate utf8_bin NOT NULL,
...
--
-- Dumping data for table `richterorder_product`
--

INSERT INTO `richterorder_product` (`order_product_id`, `order_id`, `product_id`, `name`, `model`, `price`, `total`, `tax`, `quantity`, `art`, `auflage`, `grosse`, `titelseite`, `innenseite`, `titel`, `komentar`) VALUES
(3, 3, 49, 'Coffin Bearers', '300 dpi', 0.0000, 0.0000, 0.0000, 2, '', '', '', '', '', '', ''),
(4, 4, 49, 'Coffin Bearers', '300 dpi', 0.0000, 0.0000, 0.0000, 1, '', '', '', '', '', '', ''),
(5, 5, 49, 'Coffin Bearers', '300 dpi', 0.0000, 0.0000, 0.0000, 1, '2', '10 000', '1/1 Seite', '', '1', 'ferwer', 'wer qwe rqwer qwer '),
(6, 6, 49, 'Coffin Bearers', '300 dpi', 0.0000, 0.0000, 0.0000, 1, '2', '10 000', '1/1 Seite', '', '1', 'ferwer', 'wer qwe rqwer qwer '),
(7, 7, 49, 'Coffin Bearers', '300 dpi', 0.0000, 0.0000, 0.0000, 2, '4', '50 000', 'bis DIN A3', '1', '', 'werbebroschuren', '50 000\r\nbis din A3'),
(8, 8, 49, 'Coffin Bearers', '300 dpi', 0.0000, 0.0000, 0.0000, 2, '4', '50 000', 'bis DIN A3', '1', '', 'werbebroschuren', '50 000\r\nbis din A3'),
(9, 9, 49, 'Coffin Bearers', '300 dpi', 0.0000, 0.0000, 0.0000, 2, '4', '50 000', 'bis DIN A3', '1', '', 'werbebroschuren', '50 000\r\nbis din A3'),
(10, 10, 49, 'Coffin Bearers', '300 dpi', 0.0000, 0.0000, 0.0000, 2, '4', '50 000', 'bis DIN A3', '1', '', 'werbebroschuren', '50 000\r\nbis din A3'),
(11, 11, 49, 'Coffin Bearers', '300 dpi', 0.0000, 0.0000, 0.0000, 2, '4', '50 000', 'bis DIN A3', '1', '', 'werbebroschuren', '50 000\r\nbis din A3'),
(12, 12, 49, 'Coffin Bearers', '300 dpi', 0.0000, 0.0000, 0.0000, 2, '4', '50 000', 'bis DIN A3', '1', '', 'werbebroschuren', '50 000\r\nbis din A3'),
(13, 13, 49, 'Coffin Bearers', '300 dpi', 0.0000, 0.0000, 0.0000, 2, '4', '50 000', 'bis DIN A3', '1', '', 'werbebroschuren', '50 000\r\nbis din A3'),
(14, 14, 49, 'Coffin Bearers', '300 dpi', 0.0000, 0.0000, 0.0000, 2, '4', '50 000', 'bis DIN A3', '1', '', 'werbebroschuren', '50 000\r\nbis din A3');

-- --------------------------------------------------------

--
-- Table structure for table `richterorder_status`
--

CREATE TABLE IF NOT EXISTS `richterorder_status` (
...
--
-- Dumping data for table `richterorder_status`
--

INSERT INTO `richterorder_status` (`order_status_id`, `language_id`, `name`) VALUES
(1, 1, 'Pending'),
(7, 2, 'Abgesagt'),
(5, 2, 'Bezahlt'),
(10, 1, 'Failed'),
...
--
-- Table structure for table `richterorder_total`
--

CREATE TABLE IF NOT EXISTS `richterorder_total` (
...
--
-- Dumping data for table `richterorder_total`
--

INSERT INTO `richterorder_total` (`order_total_id`, `order_id`, `title`, `text`, `value`, `sort_order`) VALUES
(1, 1, 'Sub-Total:', '£0.00', 0.0000, 1),
(2, 1, 'Total:', '£0.00', 0.0000, 6),
(3, 2, 'Sub-Total:', '£0.00', 0.0000, 1),
(4, 2, 'Total:', '£0.00', 0.0000, 6),
(5, 3, 'Sub-Total:', '£0.00', 0.0000, 1),
(6, 3, 'Total:', '£0.00', 0.0000, 6),
(7, 4, 'Sub-Total:', '£0.00', 0.0000, 1),
(8, 4, 'Total:', '£0.00', 0.0000, 6),
(9, 5, 'Sub-Total:', '£0.00', 0.0000, 1),
(10, 5, 'Total:', '£0.00', 0.0000, 6),
(11, 6, 'Sub-Total:', '£0.00', 0.0000, 1),
(12, 6, 'Total:', '£0.00', 0.0000, 6),
(13, 7, 'Sub-Total:', '£0.00', 0.0000, 1),
(14, 7, 'Total:', '£0.00', 0.0000, 6),
(15, 8, 'Sub-Total:', '£0.00', 0.0000, 1),
(16, 8, 'Total:', '£0.00', 0.0000, 6),
(17, 9, 'Sub-Total:', '£0.00', 0.0000, 1),
(18, 9, 'Total:', '£0.00', 0.0000, 6),
(19, 10, 'Sub-Total:', '£0.00', 0.0000, 1),
(20, 10, 'Total:', '£0.00', 0.0000, 6),
(21, 11, 'Sub-Total:', '£0.00', 0.0000, 1),
(22, 11, 'Total:', '£0.00', 0.0000, 6),
(23, 12, 'Sub-Total:', '£0.00', 0.0000, 1),
(24, 12, 'Total:', '£0.00', 0.0000, 6),
(25, 13, 'Sub-Total:', '£0.00', 0.0000, 1),
(26, 13, 'Total:', '£0.00', 0.0000, 6),
(27, 14, 'Sub-Total:', '£0.00', 0.0000, 1),
(28, 14, 'Total:', '£0.00', 0.0000, 6);

-- --------------------------------------------------------

--
-- Table structure for table `richterproduct`
--

CREATE TABLE IF NOT EXISTS `richterproduct` (
...
--
-- Dumping data for table `richterproduct`
--

INSERT INTO `richterproduct` (`product_id`, `model`, `sku`, `location`, `quantity`, `stock_status_id`, `image`, `manufacturer_id`, `shipping`, `price`, `tax_class_id`, `date_available`, `weight`, `weight_class_id`, `length`, `width`, `height`, `length_class_id`, `status`, `date_added`, `date_modified`, `viewed`, `sort_order`, `subtract`, `minimum`, `cost`) VALUES
(49, '300 dpi', '5', '1963', -3, 5, 'data/P_005.jpg', 0, 1, 0.0000, 0, '2011-05-17', 79.29, 1, 0.00, 37.00, 38.00, 1, 1, '2011-05-18 12:17:04', '2011-05-18 13:15:40', 0, 1, 1, 1, 0.0000);

-- --------------------------------------------------------

--
-- Table structure for table `richterproduct_description`
--

CREATE TABLE IF NOT EXISTS `richterproduct_description` (
  `product_id` int(11) NOT NULL auto_increment,
  `language_id` int(11) NOT NULL,
  `name` varchar(255) collate utf8_bin NOT NULL,
  `meta_keywords` varchar(255) collate utf8_bin NOT NULL,
...
--
-- Dumping data for table `richterproduct_description`
--

INSERT INTO `richterproduct_description` (`product_id`, `language_id`, `name`, `meta_keywords`, `meta_description`, `description`) VALUES
(49, 1, 'Coffin Bearers', '135 x 180 cm', 'Oil on canvas', 0x266c743b702667743b0d0a09434d594b266c743b2f702667743b0d0a),
(49, 2, 'Sargträger', '135 x 180 cm', 'Öl auf Leinwand', 0x266c743b702667743b0d0a09434d594b266c743b2f702667743b0d0a);

-- --------------------------------------------------------

--
-- Table structure for table `richterproduct_discount`
--

CREATE TABLE IF NOT EXISTS `richterproduct_discount` (
...
--
-- Dumping data for table `richterproduct_discount`
--
...
--
-- Table structure for table `richterproduct_featured`
--

CREATE TABLE IF NOT EXISTS `richterproduct_featured` (
  `product_id` int(11) NOT NULL default '0',
  PRIMARY KEY  (`product_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

--
-- Dumping data for table `richterproduct_featured`
--

INSERT INTO `richterproduct_featured` (`product_id`) VALUES
(28),
(42),
(43),
(44),
...
--
-- Table structure for table `richterproduct_image`
--

CREATE TABLE IF NOT EXISTS `richterproduct_image` (
...
--
-- Dumping data for table `richterproduct_image`
--
...
--
-- Table structure for table `richterproduct_option`
--

CREATE TABLE IF NOT EXISTS `richterproduct_option` (
...
--
-- Dumping data for table `richterproduct_option`
--
...
--
-- Table structure for table `richterproduct_option_description`
--

CREATE TABLE IF NOT EXISTS `richterproduct_option_description` (
...
--
-- Dumping data for table `richterproduct_option_description`
--
...
--
-- Table structure for table `richterproduct_option_value`
--

CREATE TABLE IF NOT EXISTS `richterproduct_option_value` (
...
--
-- Dumping data for table `richterproduct_option_value`
--
...
--
-- Table structure for table `richterproduct_option_value_description`
--

CREATE TABLE IF NOT EXISTS `richterproduct_option_value_description` (
...
--
-- Dumping data for table `richterproduct_option_value_description`
--
...
--
-- Table structure for table `richterproduct_related`
--

CREATE TABLE IF NOT EXISTS `richterproduct_related` (
  `product_id` int(11) NOT NULL,
...
--
-- Dumping data for table `richterproduct_related`
--
...
--
-- Table structure for table `richterproduct_special`
--

CREATE TABLE IF NOT EXISTS `richterproduct_special` (
...
--
-- Dumping data for table `richterproduct_special`
--

INSERT INTO `richterproduct_special` (`product_special_id`, `product_id`, `customer_group_id`, `priority`, `price`, `date_start`, `date_end`) VALUES
(251, 42, 8, 1, 50.0000, '2010-02-01', '2010-02-28'),
(254, 49, 8, 1, 50.0000, '2010-02-01', '2010-02-28'),
...
--
-- Table structure for table `richterproduct_tags`
--

CREATE TABLE IF NOT EXISTS `richterproduct_tags` (
  `product_id` int(11) NOT NULL,
...
--
-- Dumping data for table `richterproduct_tags`
--

INSERT INTO `richterproduct_tags` (`product_id`, `tag`, `language_id`) VALUES
(49, '', 1),
(49, '', 2);
...
--
-- Table structure for table `richterproduct_to_category`
--

CREATE TABLE IF NOT EXISTS `richterproduct_to_category` (
  `product_id` int(11) NOT NULL,
  `category_id` int(11) NOT NULL,
...
--
-- Dumping data for table `richterproduct_to_category`
--

INSERT INTO `richterproduct_to_category` (`product_id`, `category_id`) VALUES
(49, 35);

-- --------------------------------------------------------

--
-- Table structure for table `richterproduct_to_download`
--

CREATE TABLE IF NOT EXISTS `richterproduct_to_download` (
  `product_id` int(11) NOT NULL,
  `download_id` int(11) NOT NULL,
...
--
-- Dumping data for table `richterproduct_to_download`
--
...
--
-- Table structure for table `richterproduct_to_store`
--

CREATE TABLE IF NOT EXISTS `richterproduct_to_store` (
  `product_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL default '0',
...
--
-- Dumping data for table `richterproduct_to_store`
--

INSERT INTO `richterproduct_to_store` (`product_id`, `store_id`) VALUES
(49, 0);

-- --------------------------------------------------------

--
-- Table structure for table `richterreview`
--

CREATE TABLE IF NOT EXISTS `richterreview` (
...
--
-- Dumping data for table `richterreview`
--
...
--
-- Table structure for table `richtersetting`
--

CREATE TABLE IF NOT EXISTS `richtersetting` (
  `setting_id` int(11) NOT NULL auto_increment,
  `group` varchar(32) collate utf8_bin NOT NULL,
  `key` varchar(64) collate utf8_bin NOT NULL default '',
  `value` text collate utf8_bin NOT NULL,
  PRIMARY KEY  (`setting_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=493 ;

--
-- Dumping data for table `richtersetting`
--

INSERT INTO `richtersetting` (`setting_id`, `group`, `key`, `value`) VALUES
(4, 'cod', 'cod_sort_order', 0x31),
(5, 'sub_total', 'sub_total_sort_order', 0x31),
(6, 'cod', 'cod_status', 0x31),
(7, 'cod', 'cod_geo_zone_id', 0x30),
(9, 'sub_total', 'sub_total_status', 0x31),
(10, 'cod', 'cod_order_status_id', 0x31),
(11, 'tax', 'tax_status', 0x31),
(12, 'tax', 'tax_sort_order', 0x35),
(13, 'total', 'total_sort_order', 0x36),
(14, 'total', 'total_status', 0x31),
(344, 'free_checkout', 'free_checkout_sort_order', ''),
(343, 'free_checkout', 'free_checkout_status', 0x31),
(342, 'free_checkout', 'free_checkout_order_status_id', 0x37),
(491, 'config', 'config_error_log', 0x31),
(492, 'config', 'config_error_filename', 0x6572726f722e747874),
(490, 'config', 'config_error_display', 0x31),
(489, 'config', 'config_compression', 0x30),
(488, 'config', 'config_seo_url', 0x30),
(487, 'config', 'config_encryption', 0x3132333435),
(486, 'config', 'config_maintenance', 0x30),
(485, 'config', 'config_ssl', 0x30),
(484, 'config', 'config_alert_emails', ''),
(483, 'config', 'config_alert_mail', 0x30),
(482, 'config', 'config_smtp_timeout', 0x35),
(481, 'config', 'config_smtp_port', 0x3235),
(480, 'config', 'config_smtp_password', ''),
(479, 'config', 'config_smtp_username', ''),
(478, 'config', 'config_smtp_host', ''),
(477, 'config', 'config_mail_parameter', ''),
(476, 'config', 'config_mail_protocol', 0x736d7470),
(475, 'config', 'config_image_cart_height', 0x3735),
(474, 'config', 'config_image_cart_width', 0x3735),
(473, 'config', 'config_image_related_height', 0x313230),
(472, 'config', 'config_image_related_width', 0x313230),
(471, 'config', 'config_image_additional_height', 0x313530),
(469, 'config', 'config_image_product_height', 0x313230),
(470, 'config', 'config_image_additional_width', 0x313530),
(468, 'config', 'config_image_product_width', 0x313230),
(467, 'config', 'config_image_category_height', 0x313230),
(466, 'config', 'config_image_category_width', 0x313230),
(465, 'config', 'config_image_popup_height', 0x353030),
(464, 'config', 'config_image_popup_width', 0x353030),
(463, 'config', 'config_image_thumb_height', 0x323530),
(461, 'config', 'config_icon', 0x646174612f636172742e706e67),
(462, 'config', 'config_image_thumb_width', 0x323530),
(459, 'config', 'config_shipping_session', 0x30),
(460, 'config', 'config_logo', 0x646174612f6c6f676f2e706e67),
(458, 'config', 'config_cart_weight', 0x30),
(457, 'config', 'config_download_status', 0x35),
(456, 'config', 'config_download', 0x30),
(454, 'config', 'config_stock_status_id', 0x35),
(455, 'config', 'config_review', 0x30),
(453, 'config', 'config_order_status_id', 0x31),
(452, 'config', 'config_stock_checkout', 0x31),
(451, 'config', 'config_stock_warning', 0x30),
(450, 'config', 'config_stock_display', 0x30),
(449, 'config', 'config_checkout_id', 0x30),
(448, 'config', 'config_account_id', 0x30),
(447, 'config', 'config_guest_checkout', 0x30),
(446, 'config', 'config_customer_approval', 0x31),
(445, 'config', 'config_customer_price', 0x30),
(444, 'config', 'config_customer_group_id', 0x38),
(443, 'config', 'config_invoice_prefix', 0x494e56),
(442, 'config', 'config_invoice_id', 0x303031),
(441, 'config', 'config_tax', 0x31),
(440, 'config', 'config_catalog_limit', 0x3230),
(439, 'config', 'config_admin_limit', 0x3230),
(438, 'config', 'config_weight_class', 0x6b67),
(437, 'config', 'config_length_class', 0x636d),
(436, 'config', 'config_currency_auto', 0x31),
(435, 'config', 'config_currency', 0x474250),
(434, 'config', 'config_admin_language', 0x656e),
(433, 'config', 'config_language', 0x656e),
(432, 'config', 'config_zone_id', 0x33353633),
(431, 'config', 'config_country_id', 0x323232),
(430, 'config', 'config_description_2', ''),
(429, 'config', 'config_description_1', 0x266c743b702667743b0d0a0957656c636f6d6520746f206d792073746f726521266c743b2f702667743b0d0a),
(428, 'config', 'config_template', 0x64656661756c74),
(427, 'config', 'config_meta_description', 0x4d792053746f7265),
(426, 'config', 'config_title', 0x596f75722053746f7265),
(425, 'config', 'config_fax', ''),
(424, 'config', 'config_telephone', 0x313233343536373839),
(423, 'config', 'config_email', 0x7676657268756e40676d61696c2e636f6d),
(422, 'config', 'config_address', 0x416464726573732031),
(421, 'config', 'config_owner', 0x596f7572204e616d65),
(420, 'config', 'config_url', 0x687474703a2f2f6c6f63616c686f73743a3135322f),
(419, 'config', 'config_name', 0x596f75722053746f7265);

-- --------------------------------------------------------

--
-- Table structure for table `richterstock_status`
--

CREATE TABLE IF NOT EXISTS `richterstock_status` (
...
--
-- Dumping data for table `richterstock_status`
--

INSERT INTO `richterstock_status` (`stock_status_id`, `language_id`, `name`) VALUES
(7, 1, 'In Stock'),
(5, 1, 'Out Of Stock'),
(6, 1, '2 - 3 Days'),
(8, 1, 'Pre-Order'),
...
--
-- Table structure for table `richterstore`
--

CREATE TABLE IF NOT EXISTS `richterstore` (
...
--
-- Dumping data for table `richterstore`
--
...
--
-- Table structure for table `richterstore_description`
--

CREATE TABLE IF NOT EXISTS `richterstore_description` (
  `store_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `description` text collate utf8_bin NOT NULL,
...
--
-- Dumping data for table `richterstore_description`
--
...
--
-- Table structure for table `richtertax_class`
--

CREATE TABLE IF NOT EXISTS `richtertax_class` (
...
--
-- Dumping data for table `richtertax_class`
--

INSERT INTO `richtertax_class` (`tax_class_id`, `title`, `description`, `date_added`, `date_modified`) VALUES
(9, 'Taxable Goods', 'Taxed Stuff', '2009-01-06 23:21:53', '2010-02-26 22:08:04');

-- --------------------------------------------------------

--
-- Table structure for table `richtertax_rate`
--

CREATE TABLE IF NOT EXISTS `richtertax_rate` (
...
--
-- Dumping data for table `richtertax_rate`
--

INSERT INTO `richtertax_rate` (`tax_rate_id`, `geo_zone_id`, `tax_class_id`, `priority`, `rate`, `description`, `date_modified`, `date_added`) VALUES
(82, 3, 9, 1, 17.5000, 'VAT 17.5%', '0000-00-00 00:00:00', '2010-02-26 22:08:04');

-- --------------------------------------------------------

--
-- Table structure for table `richterurl_alias`
--

CREATE TABLE IF NOT EXISTS `richterurl_alias` (
  `url_alias_id` int(11) NOT NULL auto_increment,
  `query` varchar(255) collate utf8_bin NOT NULL,
  `keyword` varchar(255) collate utf8_bin NOT NULL,
  PRIMARY KEY  (`url_alias_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=489 ;

--
-- Dumping data for table `richterurl_alias`
--

INSERT INTO `richterurl_alias` (`url_alias_id`, `query`, `keyword`) VALUES
...
--
-- Table structure for table `richteruser`
--

CREATE TABLE IF NOT EXISTS `richteruser` (
...
--
-- Dumping data for table `richteruser`
--

INSERT INTO `richteruser` (`user_id`, `user_group_id`, `username`, `password`, `firstname`, `lastname`, `email`, `status`, `ip`, `date_added`) VALUES
(1, 1, 'admin', '21232f297a57a5a743894a0e4a801fc3', '', '', '', 1, '127.0.0.1', '2011-05-16 23:09:12');

-- --------------------------------------------------------

--
-- Table structure for table `richteruser_group`
--

CREATE TABLE IF NOT EXISTS `richteruser_group` (
...
--
-- Dumping data for table `richteruser_group`
--

INSERT INTO `richteruser_group` (`user_group_id`, `name`, `permission`) VALUES
(1, 'Top Administrator', ),
(10, 'Demonstration', );

-- --------------------------------------------------------

--
-- Table structure for table `richterweight_class`
--

CREATE TABLE IF NOT EXISTS `richterweight_class` (
...
--
-- Dumping data for table `richterweight_class`
--

INSERT INTO `richterweight_class` (`weight_class_id`, `value`) VALUES
(1, 1.00000000),
(2, 1000.00000000),
(5, 2.20460000),
(6, 35.27400000);
...
--
-- Table structure for table `richterweight_class_description`
--

CREATE TABLE IF NOT EXISTS `richterweight_class_description` (
  `weight_class_id` int(11) NOT NULL auto_increment,
  `language_id` int(11) NOT NULL,
  `title` varchar(32) collate utf8_bin NOT NULL,
...
--
-- Dumping data for table `richterweight_class_description`
--

INSERT INTO `richterweight_class_description` (`weight_class_id`, `language_id`, `title`, `unit`) VALUES
(1, 1, 'Kilogram', 'kg'),
(2, 1, 'Gram', 'g'),
(5, 1, 'Pound ', 'lb'),
(6, 1, 'Ounce', 'oz'),
...
--
-- Table structure for table `richterzone`
--

CREATE TABLE IF NOT EXISTS `richterzone` (
...
--
-- Dumping data for table `richterzone`
--

INSERT INTO `richterzone` (`zone_id`, `country_id`, `code`, `name`, `status`) VALUES
...
--
-- Table structure for table `richterzone_to_geo_zone`
--

CREATE TABLE IF NOT EXISTS `richterzone_to_geo_zone` (
...
--
-- Dumping data for table `richterzone_to_geo_zone`
--

INSERT INTO `richterzone_to_geo_zone` (`zone_to_geo_zone_id`, `country_id`, `zone_id`, `geo_zone_id`, `date_added`, `date_modified`) VALUES
