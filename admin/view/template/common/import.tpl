...
<div class="box">
  ...
  <table style="width:100%; border:1px solid;">
  	...
  	<tr style=" border:1px solid;">  	
  		<td>
  			<? echo $i.". "?><a target="_blank" href="index.php?route=catalog/product/update&token=<?php echo $this->session->data['token']; ?>&product_id=<?php echo $error['product_id']; ?>" class="top"><?php echo $error['file']; ?></a>
  		</td>	
  	</tr>
  	<tr >  
  		<td>
