...
class ControllerAccountLogin extends Controller {
    ...
    public function index() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
            ...
            if (isset($this->request->post['email']) && isset($this->request->post['password']) && $this->validate_admin()) {

                if (isset($this->request->post['redirect'])) {
                    $this->redirect(str_replace('&amp;', '&', $this->request->post['redirect']));
                } else {
                    $this->redirect(HTTPS_SERVER . 'index.php?route=sale/customer');
                }
            } elseif (isset($this->request->post['email']) && isset($this->request->post['password']) && $this->validate()) {
        ...
        $this->data['text_Zugangsdaten'] = $this->language->get('text_Zugangsdaten');
        $this->data['text_Benutzername'] = $this->language->get('text_Benutzername');
        $this->data['text_Passwort'] = $this->language->get('text_Passwort');
        $this->data['text_qwestion'] = $this->language->get('text_qwestion');
    ...
    private function validate() {
        ...
        if (!$this->customer->login2($this->request->post['email'], $this->request->post['password'])) {
