	...
	private $error = array();
  	...
  	public function index() {	
    	...
    	if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->model_account_customer->editPasswordAdmin( $this->request->post['password'] );
 
      		$this->session->data['success'] = $this->language->get('text_success');
	 
	  
	  		//$this->redirect(HTTPS_SERVER . 'index.php?route=account/password');
    	}
		...
		if (isset($this->session->data['success']) && trim($this->session->data['success']) != ''){
			$this->data['success_password'] = $this->session->data['success'];
