...
class ControllerAccountEdit extends Controller {
    ...
    public function index() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            ...
            if (!isset($this->request->post['back'])) {
                ...
                $this->redirect($this->request->post['back']);
            }
        }
        ...
        if (isset($this->request->post['ansprechpartner2'])) {
            $this->data['ansprechpartner2'] = $this->request->post['ansprechpartner2'];
        } elseif (isset($customer_info)) {
            $this->data['ansprechpartner2'] = $customer_info['ansprechpartner2'];
        } else {
            $this->data['ansprechpartner2'] = '';
        }
    ...
    private function validate() {
        ...
        if ((!$this->user->isLogged() && $this->customer->getEmail() != $this->request->post['email']) && $this->model_account_customer->getTotalCustomersByEmail($this->request->post['email'])) {
