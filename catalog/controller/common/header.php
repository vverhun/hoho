...
class ControllerCommonHeader extends Controller {
	protected function index() {
		...
		//print_r($this->request->post['language_code']);
		//die();
		...
		$this->data['impressum'] = $this->language->get('impressum');
		$this->data['text_already'] = $this->language->get('text_already');
		...
		$this->data['logged'] = $this->customer->isLogged() || $this->user->isLogged();
		...
		$this->data['text_Lize'] = $this->language->get('text_Lize');
		$this->data['text_Regis'] = $this->language->get('text_Regis');
		$this->data['text_Contakt'] = $this->language->get('text_Contakt');
		$this->data['text_editMyAccount'] = $this->language->get('text_editMyAccount');
		$this->data['text_Pr_verwaltung'] = $this->language->get('text_Pr_verwaltung');
		$this->data['text_waltung'] = $this->language->get('text_waltung');
		$this->data['text_Anfragen'] = $this->language->get('text_Anfragen');
		$this->data['text_Pr_archiv'] = $this->language->get('text_Pr_archiv');
		$this->data['text_Abwesenheit'] = $this->language->get('text_Abwesenheit');
		$this->data['text_Shop'] = $this->language->get('text_Shop');

		$this->data['text_added'] = $this->language->get('text_added');
		if ($this->customer->isLogged()){
			$this->data['firstname'] = $this->customer->getFirstname();
			$this->data['ansprechpartner'] = $this->customer->getAnsprechpartner();
		}
		...
		$this->data['countproducts']  = $this->cart->countProducts();
