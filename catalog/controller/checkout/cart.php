...
class ControllerCheckoutCart extends Controller {
	...
	public function index() {
		...
		$this->data['my_shopcart'] = $this->language->get('my_shopcart');
	    ...
	    $this->data['lastcomment'] = $this->language->get('lastcomment');
		...
		$this->data['my_1'] = $this->language->get('my_1');
		$this->data['my_2'] = $this->language->get('my_2');
		$this->data['my_title_poblication'] = $this->language->get('my_title_poblication');
		$this->data['my_comment'] = $this->language->get('my_comment');
		$this->data['required'] = $this->language->get('required');

		$this->data['my_anfragen'] = $this->language->get('my_anfragen');
		$this->data['my_einkauf'] = $this->language->get('my_einkauf');

		$this->data['weitere'] = $this->language->get('weitere');
		$this->data['seite'] = $this->language->get('seite');
		$this->data['gdin'] = $this->language->get('gdin');
		$this->data['din'] = $this->language->get('din');
		$this->data['daruber'] = $this->language->get('daruber');
		...
		if ($this->cart->hasProducts()) {
			...
			$this->data['checkout'] = HTTPS_SERVER . 'index.php?route=checkout/confirm';
