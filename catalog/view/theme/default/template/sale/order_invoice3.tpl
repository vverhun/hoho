...
<?php foreach ($orders as $order) { ?>
 ...
 <br>    
   <div class="div1">&nbsp;<?php if (strlen($order['firstname'] > 40)){ echo substr_replace($order['firstname'], "<br>&nbsp;", 40, 0);} else { echo $order['firstname'];}   ?><br>&nbsp;<?php echo $order['lastname']; ?> <br>
         <?php if ( $order['ansprechpartner'] != '' ) { echo $order['ansprechpartner']; ?> <br> <?php } ?>
        <?php echo $order['position']; ?> <br>
  ...
  <br><br>
  <TABLE WIDTH=100% >
  <tr><td width=10% align=left><b>INVOICE No.</b></td><td width=80% align=left> <b>VAT No.</b></td><td width=10% class="first"> <b>DATE OF INVOICE</b></td></tr>
  <tr><td width=10% align=left>C <?php echo $order['order_id']; ?>/<?php echo $order['year']; ?></td><td width=80% align=left><?php echo $order['taxid']; ?> </td><td align=left width=10% class="sec"> <?php echo $order['date_added']; ?></td></tr></TABLE>
...
<TABLE WIDTH=100% >
   ...
   <tr><td align=left class="totalfirst" width=18%><b> </b></td><td class="totalempty"  width=50%>&nbsp;</td><td class="totalmiddle" width=15%>0 %TAX</td><td class="totalsec" width=17% align="right"><?php echo   sprintf('%.2f',$order['tax']); ?> €<hr></td></tr>
...
<hr>
 ...
 <tr>
     <td class="footer" align=center>   <br><br>  
  ...
  <tr>
   ...
   <tr>
      <td class="footer" align=center>Without VAT according to Art. 24, 25, 43, 44 of the Council Directive 2006/112/EC</td>
 </tr>
   <tr>
      <td class="footer" align=center>Persons to whom  the services are supplied are liable to tax (Reverse Charge) according to Art.</td>
 </tr>
   <tr>
      <td class="footer" align=center>196 of the Council Directive 2006/112/EC</td>
 </tr>
   <tr>
