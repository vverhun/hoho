...
<div class="box">
    ...
    <div style="margin-left:15px; line-height:22px;">
        <a href="/index.php?route=sale/order/anfragen">Offen Anfragen:</a><span style="color:red; padding-left:59px;"><? echo $offen; ?></span><br>
        <b>Bearbeitete Anfragen:</b><span style="color:blue; padding-left:5px;"><? echo $angebot; ?></span><br>
    </div>
    <br>
    <h2>Bearbeitete Anfragen</h2>
				   ...
				   <?} else if ($product['status_id'] == 0) { ?>
                            ...
                            <table border=0 width=100%  style="float:left;margin-top:-7px;"><tr>
                                    ...
                                    <td valign=top align=right   style="width:30%;padding-right:15px;background-color:white;">
                                        ...
                                        <input type="hidden" name="realprice1<?php echo $product['product_id']; ?>" id="realprice1<?php echo $product['product_id'].$order['order_id']; ?>" value="<?php echo  sprintf('%.2f',$product['realprice']);  ?>">
                                        ...
                                        <table border=0 cellpadding=0 cellspacing=0  class='price'>
                                            <tr><td align=right>
                                                    Reproduktionskosten:&nbsp;&nbsp;<span style="color:red;"><?php echo  sprintf('%.2f',$product['price']);  ?>  &euro;</span> 
                                                    <br>(+/- %):&nbsp;&nbsp; <?php echo sprintf('%.2f',round($product['pricediscount'],2)); ?>      
                                                </td></tr>

                                            <tr><td align=right>
                                                    Datenversand:&nbsp;&nbsp;  <span style="color:red"><?php echo  sprintf('%.2f',round($product['tax'],2));  ?>  &euro;</span> 
                                                    <br>(+/- %):&nbsp;&nbsp;   <?php echo sprintf('%.2f',round($product['taxdiscount'],2)); ?>     
                                            </td></tr><tr><td align=right>SUMME: <span  style="color:red" ><?php echo  sprintf('%.2f',$product['total']);  ?>  &euro;</span><div class="separator">&nbsp;</div></td></tr>
                                        </table>
                                               
                                               
                                               <table border=0 cellpadding=0 cellspacing=0  class='price' style="display:none;">
                                                    ...
                                                    <tr><td align=right>
                                                            ...
                                                            <br>(+/- %):&nbsp;&nbsp; <input orderid='<?php echo $order['order_id'];?>' type="text" rel="<?php echo $product['product_id']; ?>" size=5 class="firstinput" name="first<?php echo $product['product_id']; ?>" value='<? echo $product['pricediscount']; ?>' />
                                                    </td></tr>
                                                    ...
                                                    <tr><td align=right>
                                                            ...
                                                            <br>(+/- %):&nbsp;&nbsp;<input orderid='<?php echo $order['order_id'];?>' type="text" rel="<?php echo $product['product_id']; ?>" size=5 class="secondinput" name="second<?php echo $product['product_id']; ?>" value='<? echo $product['taxdiscount']; ?>' /></td></tr>
                            ...
                            <div style="margin-left: -6px; width:17%;text-align:left; float:left;   margin-bottom: -8px; padding:7px; background-color: #DDDDDC;" >

                                <input type="button" value="Bearbeiten" class="sbmt_button" onClick ="$(this).toggle(); $('#form<?php echo $order["order_id"];?> .neues').toggle(); $('#form<?php echo $order["order_id"];?> .price').toggle();" />
                                <input type="button" style="display:none;" alt="Möchten Sie ein <br> neues Angebot senden?" value="neues Angebot senden" class="neues confirmdialogopener_angebot sbmt_button" rel='#form<?php echo $order["order_id"];?>' >

                            </div>
                            <div style="margin-left: -6px; width:45%;text-align:left; float:left;   margin-bottom: -8px; padding:7px; background-color: #DDDDDC;" >

                                <input type="button"  value="Druken" class="sbmt_button" onclick="window.location.href = '/index.php?route=sale/order/printorder&order_id=<?php echo $order["order_id"];?>'" >

                            </div>

                            <div style="margin-left: -2px; width:17.2%;text-align:left; float:left;   margin-bottom: -8px; padding:7px; background-color: #DDDDDC;" >

                                <input type="button" alt='Möchten Sie die Anfrage<br>aus dem System löschen?' value="Löschen" class="confirmdialogopener sbmt_button" rel='/index.php?route=sale/order/delete&order_id=<?php echo $order["order_id"];?>&back=bearbeitete' >

                            </div>


                            <div style="margin-left: 0px;width: 15.8%;text-align: right;float: right;margin-bottom: -11px;padding: 7px;background-color: #DDDDDC;" >
