...
class ModelCheckoutOrder extends Model {
	...
	public function create($data) {
		...
		foreach ($data['products'] as $product) { 
   			...
   			$this->db->query("INSERT INTO " . DB_PREFIX . "order_product SET komentar = '" . $this->db->escape($product['komentar']) . "', titel = '" . $this->db->escape($product['titel']) . "', innenseite = '" . $this->db->escape($product['innenseite']) . "', titelseite = '" . $this->db->escape($product['titelseite']) . "', grosse = '" . $this->db->escape($product['grosse']) . "', auflage = '" . $this->db->escape($product['auflage']) . "', art = '" . $this->db->escape($product['art']) . "', order_id = '" . (int)$order_id . "', product_id = '" . (int)$product['product_id'] . "', name = '" . $this->db->escape($product['name']) . "', model = '" . $this->db->escape($product['model']) . "', price = '" . (float)$product['price'] . "', total = '" . (float)$product['total'] . "', tax = '" . (float)$product['tax'] . "', quantity = '" . (int)$product['quantity'] . "'");
